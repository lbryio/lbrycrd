...
define $(package)_build_cmds
  ./b2 -d2 -j`nproc` -d1 --reconfigure --prefix=$($(package)_staging_prefix_dir) $($(package)_config_opts) stage
endef

define $(package)_stage_cmds
  ./b2 -d0 -j`nproc` --prefix=$($(package)_staging_prefix_dir) $($(package)_config_opts) install
endef
