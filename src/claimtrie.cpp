...
void CClaimTrie::clear(const CClaimTrieNode& current)
{
...
void CClaimTrie::markNodeDirty(const std::string &name, const CClaimTrieNode& node)
{
...
void CheckTrie(const CClaimTrieCache* cache)
{
    static int count = 0;
