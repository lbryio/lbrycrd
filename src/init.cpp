...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-maxblockfilesize=<n>", strprintf("Keep the block files below n megabytes each. (default: %d, minimum: 8)", DEFAULT_MAX_BLOCKFILE_SIZE >> 20U), ArgsManager::ALLOW_INT, OptionsCategory::OPTIONS);
